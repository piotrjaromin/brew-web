...
func main() {
        ...
        mux.Handle("/heaters/1", web.CreateHandlerForHeater(keg.FIRST, kegControl))
        mux.Handle("/heaters/2", web.CreateHandlerForHeater(keg.SECOND, kegControl))
        mux.Handle("/temperatures", web.CreateTempHandler(tempCache))
        mux.Handle("/temperatures/control", web.CreateTempControlHandler(tempControl))
        mux.Handle("/recipes", web.CreateRecipesHandler(cook))
